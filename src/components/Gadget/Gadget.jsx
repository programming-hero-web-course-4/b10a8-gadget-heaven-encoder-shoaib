    ...
    return (
        <div className='border rounded-2xl shadow-lg p-4 bg-gray-100'>
            ...
            <div className='mt-4'>
                ...
                <Link to={`/product/${product_id}`} onClick={()=>handleDashboardClick('Dashboard')} className='text-[#a032cb] text-md font-bold border rounded-full p-2 mt-2'>View Details</Link>
            </div>
        </div>
    );
};
